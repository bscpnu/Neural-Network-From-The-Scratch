...
with tf.Session() as sess:
    ...
    weight1, weight2, weight3, weight4, weight5, weight6, weight7, weight8, weight9, b1, b2, b3, loss = sess.run([W1, W2, W3, W4, W5, W6, W7, W8, W9, b1,b2,b3, loss], {X1:x1,X2:x2,Y:y})
    print("W1: %s W2: %s W3: %s W4: %s W5: %s W6: %s W7: %s W8: %s W9: %s b1: %s b2: %s b3: %s loss: %s"%(weight1, weight2, weight3, weight4, weight5, weight6, weight7, weight8, weight9, b1, b2, b3, loss))